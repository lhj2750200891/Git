...
#define NRF24L01_CE_GPIO_PIN               GPIO_PIN_10
...
#define NRF24L01_CSN_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)   /* PG口时钟使能 */

#define NRF24L01_IRQ_GPIO_PORT             GPIOD
#define NRF24L01_IRQ_GPIO_PIN              GPIO_PIN_7
#define NRF24L01_IRQ_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* PG口时钟使能 */
...
extern  uint8_t tmp_buf[33];
void nrf24l01_send_data3(uint8_t data1,uint8_t data2, uint8_t data3);
#endif
