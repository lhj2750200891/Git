...
SPI_HandleTypeDef g_spi2_handler; /* SPI1句柄 */
...
void spi2_init(void)
{
    ...
    g_spi2_handler.Instance = SPI2_SPI;                                /* SPI1 */
...
void HAL_SPI_MspInit(SPI_HandleTypeDef *hspi)
{
    ...
    {
        SPI2_SCK_GPIO_CLK_ENABLE();  /* SPI1_SCK脚时钟使能 */
        SPI2_MISO_GPIO_CLK_ENABLE(); /* SPI1_MISO脚时钟使能 */
        SPI2_MOSI_GPIO_CLK_ENABLE(); /* SPI1_MOSI脚时钟使能 */
        ...
        gpio_init_struct.Alternate = NRF24L01_GPIO_AF_SPI2;
