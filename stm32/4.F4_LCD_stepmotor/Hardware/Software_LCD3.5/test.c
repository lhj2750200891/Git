...
void LCD_Static_Show(void)
{
	...
	LCD_ShowString(0,105,16,"StepMotor_ID:",1);
	LCD_ShowString(0,125,16,"StepMotor_CW: ",1);
	LCD_ShowString(0,145,16,"StepMotor_CCW: ",1);
	LCD_ShowNum(125,125,0,3,16);
	LCD_ShowNum(125,143,0,3,16);
	LCD_ShowString(245,0,16,"StepMotor_1: ",1);
	LCD_ShowString(245,25,16,"StepMotor_2: ",1);
	LCD_ShowString(245,45,16,"StepMotor_3: ",1);
	LCD_ShowString(245,65,16,"StepMotor_4: ",1);
...
//	LCD_ShowNum(80,20,ADC_Vol2,2,16); //小数部分
	...
	LCD_ShowNum(125,105,id,3,16);
	if(keyflag==2)
	{
		LCD_ShowNum(125,125,1,3,16);
		LCD_ShowNum(125,143,0,3,16);
	}
	else if(keyflag==3) 
	{
		LCD_ShowNum(125,125,0,3,16);
		LCD_ShowNum(125,143,1,3,16);
	}
	//步进电机的脉冲数
	LCD_ShowNum(370,0,Pulse_Add.StepMotor1,5,16);  //整数部分
	LCD_ShowNum(370,25,Pulse_Add.StepMotor2,5,16);  //整数部分
	LCD_ShowNum(370,45,Pulse_Add.StepMotor3,5,16);  //整数部分
	LCD_ShowNum(370,65,Pulse_Add.StepMotor4,5,16);  //整数部分
